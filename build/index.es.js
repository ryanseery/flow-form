import { createContext, useReducer, useMemo, createElement, useContext, useEffect, Children, isValidElement, Fragment, cloneElement } from 'react';
    ...
    return (createElement("form", { onSubmit: function (e) {
        ...
        createElement("fieldset", { style: { border: "none" } },
            ...
            isFlowForm && (createElement(Fragment, null,
                flow.currentStep != null && ((_b = flow.currentStep) === null || _b === void 0 ? void 0 : _b.index) > 0 && (createElement("button", { type: "button", className: "flow-form-back-btn", onClick: function () { return goBack(); } }, "Back")),
