...
var Input = function (_a) {
    ...
    return (createElement("label", { id: id + "-label", "data-label-id": id + "-label", htmlFor: id, className: "flow-form-label " + className + "-label", style: __assign({ display: "block", minHeight: '4rem' }, style) },
        id,
        (function () {
            switch (type) {
                case 'text':
