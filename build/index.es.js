...
var Error = function (_a) {
    ...
    if (error) {
        return (createElement("small", { id: toCamelCase(id) + "-error", className: toKebabCase(name) + "-error", style: __assign({ color: 'red' }, style) }, typeof message === 'string' ? message : id + " error."));
    }
    return null;
};
...
var HelperText = function (_a) {
    ...
    if (typeof helperText === 'string') {
        return (createElement("small", { id: id + "-helper-text", className: className + "-helper-text", style: { color: '#BDBDBD' } }, helperText));
    }
    return null;
};
...
export { Error, FlowForm, Input, ShowData };
