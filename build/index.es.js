...
var FieldList = function (_a) {
    ...
    var id = useMemo(function () { return toCamelCase(name ? name : label); }, [step, label, flow.currentStep, flow.key]);
    var blankInput = useMemo(function () { return (Array.isArray(children) ? handleBlankArr(children) : handleBlankObj(children)); }, [step, label, flow.currentStep, flow.key]);
    var inputProps = useMemo(function () { return (Array.isArray(children) ? handleInputPropsArr(children) : handleInputPropsObj(children)); }, [step, label, flow.currentStep, flow.key]);
    var constructErrors = useMemo(function () { return (Array.isArray(children) ? handleErrorArr(children) : handleErrorObj(children)); }, [step, label, flow.currentStep, flow.key]);
    var constructFocus = useMemo(function () { return (Array.isArray(children) ? handleFocusArr(children) : handleFocusObj(children)); }, [step, label, flow.currentStep, flow.key]);
    useEffect(function () {
        setFieldList({
            step: step,
            id: id,
