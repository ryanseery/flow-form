...
var FileComp = function (_a) {
    ...
    return (createElement(Fragment, null,
        createElement("div", { className: "flow-form-file-upload", style: {
            ...
            createElement("input", { ref: fileRef, multiple: true, id: id + "-field-file", "data-input-id": id + "-field-file", name: id, type: "file", value: value || '', required: required, onChange: onChange, onBlur: onBlur, onFocus: onFocus, className: "flow-form-field flow-form-file " + className + "-field", autoComplete: autoComplete, style: { display: 'none' } })),
        showError && createElement(DisplayError, { id: id, className: className, label: label, errMsg: errMsg })));
};
    ...
    return (createElement("label", { id: id + "-label", "data-field-id": id + "-label", htmlFor: id, className: "flow-form-field " + className + "-label", style: __assign({ display: "block", minHeight: '4rem', textTransform: 'capitalize' }, style) },
        ...
        (function () {
            switch (type) {
                ...
                case 'fileDrop':
                    return createElement(FileComp, __assign({}, defaultProps));
                default:
                    return createElement(Text, __assign({}, defaultProps));
            }
        })()));
