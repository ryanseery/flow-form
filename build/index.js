...
var ShowData = function (_a) {
    ...
    return (React.createElement("pre", { className: "flow-form-show-data " + className, style: style }, JSON.stringify({ isFlowForm: isFlowForm, canProceed: canProceed, flow: flow, formData: formData, error: error, showError: showError, touched: touched }, null, 2)));
};
...
var ItemInput = function (_a) {
    ...
    return (React.createElement("input", { id: objKey + "-field-field-list-item-" + fieldIndex, "data-input-id": objKey + "-field-field-list-item-" + fieldIndex, name: objKey, type: type, value: value, required: required, onChange: onChange, 
        // onBlur={onBlur}
        // onFocus={onFocus}
...
var FieldList = function (_a) {
    ...
    var _b;
    var _c = React.useContext(Context), flow = _c.flow, setField = _c.setField, formData = _c.formData, updateInputListItem = _c.updateInputListItem, addInputList = _c.addInputList, removeInputList = _c.removeInputList;
    if (!children) {
    ...
    var blankInput = React.useMemo(function () { return (Array.isArray(children) ? handleBlankArr(children) : handleChildObj$1(children)); }, []);
    ...
    return (React.createElement("label", { "data-field-list-id": id, className: "flow-form-field-list " + className, style: __assign(__assign({}, style), { textTransform: 'capitalize' }) },
        ...
        !isObjectEmpty(formData) && step != null ? (React.createElement(React.Fragment, null, (_b = formData === null || formData === void 0 ? void 0 : formData[step]) === null || _b === void 0 ? void 0 : _b[id].map(function (field, index) { return (React.createElement(Row, { key: index, className: className },
            ...
            add && (React.createElement(React.Fragment, null, index === 0 ? (React.createElement(ListButton, { color: colors.green, onClick: function () { return addInputList({ step: step, id: id, blankInput: blankInput !== null && blankInput !== void 0 ? blankInput : {} }); } }, "+")) : (React.createElement(ListButton, { color: colors.red, onClick: function () { return removeInputList({ step: step, id: id, index: index }); } }, "-")))))); }))) : (React.createElement(React.Fragment, null, !isObjectEmpty(formData) && (formData === null || formData === void 0 ? void 0 : formData[id].map(function (field, index) { return (React.createElement(Row, { key: index, className: className },
            Object.entries(field).map(function (_a, i) {
                var k = _a[0], v = _a[1];
                var _b, _c, _d;
                return (React.createElement(React.Fragment, { key: i },
