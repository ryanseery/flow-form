...
var Form = function (_a) {
    var children = _a.children;
    var _b = React.useContext(Context), isFlowForm = _b.isFlowForm, flow = _b.flow, data = _b.data, error = _b.error, setForm = _b.setForm;
...
function useFormData2(_a) {
    ...
    var setInput = React.useContext(Context).setInput;
    React.useEffect(function () {
...
var Input2 = function (_a) {
    ...
    return (React.createElement("label", { htmlFor: id, className: "flow-form-label " + styleTag + "-label", style: __assign({ display: "block", minHeight: '4rem' }, style) }, children !== null && children !== void 0 ? children : name,
        React.createElement("input", { type: "text", id: id, name: id, value: value || '', style: { display: "block" } })));
};
Input2.defaultProps = {
