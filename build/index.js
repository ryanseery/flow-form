...
function useFormData(_a) {
    var id = _a.id, value = _a.value, error = _a.error;
    var _b = React.useContext(FormContext), data = _b.data, setValue = _b.setValue, updateValue = _b.updateValue;
...
var Input = function (_a) {
    ...
    //   placeholder,
    // };
    return (React.createElement("label", { htmlFor: camelCase, className: "flow-form-label " + kebabCase + "-label" },
        React.createElement("input", { type: type, placeholder: placeholder, className: "flow-form-input " + kebabCase + "-input", name: camelCase, id: camelCase, value: value || '', onChange: handleChange })));
};
...
var FormComponent = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { className: "flow-form " + (className || ''), style: { display: 'block', marginRight: '10em' }, onSubmit: function (e) {
                e.preventDefault();
                onSubmit(data);
            } },
            React.createElement("fieldset", { disabled: false, "aria-busy": false },
                children,
