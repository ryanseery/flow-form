...
var DragDrop = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: style, className: styles, onDrag: handleDefaults, onDragStart: handleDefaults, onDragEnd: handleDefaults, onDragOver: onDragOver, onDragEnter: handleDefaults, onDragLeave: onDragLeave, onDrop: onDrop, onClick: handleClick },
            React.createElement("span", { className: "drag-drop-cta" }, placeholder),
            React.createElement("input", __assign({}, rest, { id: id, required: required, ref: inputRef, type: "file", className: "drag-drop-input" }))),
...
var Field = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        (function () {
            switch (type) {
                case 'select': {
                    return React.createElement(Select, __assign({}, selectProps));
                }
                case 'textarea': {
                    return React.createElement(TextArea, __assign({}, defaultProps));
                }
                case 'radio': {
                    return React.createElement(CheckboxRadio, __assign({}, toggleProps));
                }
                case 'checkbox': {
                    return React.createElement(CheckboxRadio, __assign({}, toggleProps));
                }
                case 'drag-drop': {
                    return React.createElement(DragDrop, __assign({}, fileProps));
                }
                default: {
