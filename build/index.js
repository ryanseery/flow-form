...
var ImgPreview = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flow-form-img-preview", style: {
            ...
            typeof value === 'string' ? (React.createElement("span", { className: "flow-form-file-call-to-action", style: { fontSize: "" + theme.fonts.small, textAlign: 'center' } }, placeholder ? placeholder : "Drag and Drop or Click to upload")) : (React.createElement(React.Fragment, null,
