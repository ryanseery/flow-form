...
var Form = function (_a) {
    ...
    return (React.createElement("form", { onSubmit: function (e) {
        ...
        React.createElement("fieldset", { className: "flow-form-fieldset", style: { border: "none" } },
...
var DisplayError = function (_a) {
    ...
    return (React.createElement("small", { id: id + "-error", "data-error-id": id + "-error", className: "flow-form-error " + className + "-error", style: { color: "" + theme.colors.red } }, typeof errMsg === 'string' ? errMsg : "Please provide a valid value!"));
};
...
var ImgPreview = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flow-form-img-preview", style: {
                border: "" + border(focused, showError),
                borderRadius: "" + theme.border.radius,
                display: 'flex',
                alignItems: 'center',
            ...
            typeof value === 'string' ? (React.createElement("span", { className: "flow-form-file-call-to-action", style: { fontSize: "" + theme.fonts.small, textAlign: 'center' } }, placeholder ? placeholder : "Drag and Drop or Click to upload")) : (React.createElement("img", { className: "flow-form-img", src: URL.createObjectURL(value), alt: value.name, style: { height: '100%', width: '100%' } })),
            React.createElement("input", { ref: fileRef, multiple: true, id: id + "-field-file", "data-input-id": id + "-field-file", name: id, type: "file", required: required, onChange: onImgChange, onBlur: onBlur, onFocus: onFocus, className: "flow-form-field flow-form-drag-and-drop " + className + "-field", autoComplete: autoComplete, style: { display: 'none' } })),
        showError && React.createElement(DisplayError, { id: id, className: className, label: label, errMsg: errMsg })));
};
    ...
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '58%' } },
        options &&
            options.map(function (option, index) { return (React.createElement("label", { key: index, htmlFor: option, className: "flow-form-legend " + className + "-legend", style: {
                ...
                React.createElement("input", { id: option, "data-input-id": option + "-field-checkbox", name: id, type: type, value: option, required: required, onChange: onChange, onBlur: onBlur, onFocus: onFocus, className: "flow-form-field flow-form-text " + className + "-field", placeholder: placeholder, autoComplete: autoComplete, style: __assign(__assign({}, style), { width: '1rem', border: "" + border(focused, showError) }), checked: value === option }),
                option)); }),
        showError && React.createElement(DisplayError, { id: id, className: className, label: label, errMsg: errMsg })));
};
...
var Field = function (_a) {
    ...
    return (React.createElement("label", { id: id + "-label", "data-field-id": id + "-label", htmlFor: id, className: "flow-form-label " + className + "-label", style: {
            display: 'block',
            minHeight: "" + (type === 'checkbox' || type === 'radio' ? '4rem' : '4.5rem'),
            textTransform: 'capitalize',
        } },
        React.createElement("legend", { className: "flow-form-legend " + className + "-legend", style: { fontSize: "" + theme.fonts.medium, paddingBottom: '0.2em' } }, children ? children : name !== null && name !== void 0 ? name : ''),
        (function () {
            switch (type) {
                case 'text':
