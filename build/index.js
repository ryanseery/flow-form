...
var Form = function (_a) {
    ...
    var _b, _c;
    var _d = React.useContext(Context), isFlowForm = _d.isFlowForm, canProceed = _d.canProceed, flow = _d.flow, formData = _d.formData, setForm = _d.setForm, progressForm = _d.progressForm, revertForm = _d.revertForm, error = _d.error, showError = _d.showError, touched = _d.touched;
...
var FlowForm = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(Form, { onSubmit: onSubmit, className: className, style: style, showData: showData }, children)));
};
...
function useFormData(_a) {
    ...
    var _l = React.useContext(Context), setField = _l.setField, formData = _l.formData, error = _l.error, updateField = _l.updateField, setBlur = _l.setBlur, setFocus = _l.setFocus, showError = _l.showError, flow = _l.flow;
    React.useEffect(function () {
...
var ItemInput = function (_a) {
    ...
    return (React.createElement("input", { "data-field-id": objKey + "-field-field-list-item-" + fieldIndex, id: objKey + "-field-list-field-" + type, name: objKey, type: type, value: value, required: required, onChange: onChange, 
        // onBlur={onBlur}
        // onFocus={onFocus}
...
var FieldList = function (_a) {
    ...
    var _b;
    var _c = React.useContext(Context), flow = _c.flow, setFieldList = _c.setFieldList, formData = _c.formData, updateFieldListItem = _c.updateFieldListItem, addFieldList = _c.addFieldList, removeFieldList = _c.removeFieldList;
    if (!children) {
    ...
    return (React.createElement("label", { "data-field-list-id": id, className: "flow-form-field-list " + className, style: __assign(__assign({}, style), { textTransform: 'capitalize' }) },
        label,
        !isObjectEmpty(formData) && step != null ? (React.createElement(React.Fragment, null, (_b = formData === null || formData === void 0 ? void 0 : formData[step]) === null || _b === void 0 ? void 0 : _b[id].map(function (field, index) { return (React.createElement(Row, { key: index, className: className },
            Object.entries(field).map(function (_a, i) {
                ...
                return (React.createElement(React.Fragment, { key: i },
                    React.createElement(ItemInput, { objKey: k, fieldIndex: i, type: (_b = inputProps === null || inputProps === void 0 ? void 0 : inputProps[i].type) !== null && _b !== void 0 ? _b : 'text', value: v || '', required: (_c = inputProps === null || inputProps === void 0 ? void 0 : inputProps[i].required) !== null && _c !== void 0 ? _c : false, onChange: handleChange(index), 
                        // onBlur={onBlur}
                        // onFocus={onFocus}
