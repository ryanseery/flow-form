...
function handleTypeArr(children) {
    return React.Children.toArray(children).reduce(function (acc, child) {
        return React.isValidElement(child) ? __spreadArrays(acc, [child.props.type ? child.props.type : 'text']) : acc;
    }, []);
}
...
var FieldList = function (_a) {
    ...
    var blankInput = React.useMemo(function () { return (Array.isArray(children) ? handleBlankArr(children) : handleChildObj$1(children, ARR_TYPE.BLANK_INPUT)); }, []);
    // TODO rebuild to take all input props
    var inputTypes = React.useMemo(function () { return (Array.isArray(children) ? handleTypeArr(children) : handleChildObj$1(children, ARR_TYPE.INPUT_TYPE)); }, []);
    React.useEffect(function () {
        setField({
            step: step,
            id: id,
    ...
    return (React.createElement("label", { "data-field-list-id": id, className: "flow-form-field-list " + className, style: style },
        label,
        !isObjectEmpty(formData) && step != null ? (React.createElement(React.Fragment, null, (_b = formData === null || formData === void 0 ? void 0 : formData[step]) === null || _b === void 0 ? void 0 : _b[id].map(function (field, index) { return (React.createElement(Row, { key: index, className: className },
            Object.entries(field).map(function (_a, i) {
                ...
                return (React.createElement(React.Fragment, { key: i },
                    React.createElement(ItemInput, { objKey: k, fieldIndex: i, type: (_b = inputTypes === null || inputTypes === void 0 ? void 0 : inputTypes[i]) !== null && _b !== void 0 ? _b : 'text', value: v || '', 
                        // required='false'
